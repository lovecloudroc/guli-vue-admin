        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="讲师名称">
              <el-input v-model="teacher.name" placeholder="请输入讲师姓名"/>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="讲师简介">
              <el-input v-model="teacher.intro" :rows="10" type="textarea" placeholder="请输入讲师简介（200字内）"/>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      baseAvatar: 'https://cloudroc.oss-cn-beijing.aliyuncs.com/image/%E5%A4%B4%E5%83%8F.jpg',
